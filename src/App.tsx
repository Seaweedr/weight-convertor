            ...
            >
              ...
              <div className="absolute inset-x-[2px] inset-y-[-1px] pointer-events-none" style={{
                ...
                background: `conic-gradient(from ${dragging ? 200 : 210}deg,
                  transparent 0deg,
                  rgba(140,200,255,${dragging ? 0.7 : 0.15}) 30deg,
                  rgba(170,140,255,${dragging ? 0.6 : 0.12}) 70deg,
                  transparent 110deg,
                  transparent 180deg,
                  rgba(255,170,120,${dragging ? 0.6 : 0.12}) 220deg,
                  rgba(255,120,160,${dragging ? 0.65 : 0.14}) 260deg,
                  transparent 300deg,
                  transparent 360deg)`,
                mask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)',
                maskComposite: 'exclude',
